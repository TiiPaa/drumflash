...
- 25 types d'instruments dans 14 slots modulaires (27 voix DSP : 13 voix de synthèse d'origine, 4 samplers TR-606, Buzz, Sdrex, 6 voix AC606 modélisées, Rift, One-Shot)
...
- Generator (4 techniques : probabiliste, markov, euclidien, classique) + navigateur de presets (Instrument / Pattern / Grid / Song)

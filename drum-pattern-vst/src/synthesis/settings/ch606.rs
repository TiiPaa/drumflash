...
impl From<VoiceSettings> for Ch606Settings {
...
impl From<Ch606Settings> for VoiceSettings {
    fn from(s: Ch606Settings) -> Self {
...
mod tests {
    use super::*;
    crate::settings_roundtrip_test!(ch606_settings_roundtrip, ch606, Ch606Settings);
}

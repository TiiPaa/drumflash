...
pub const INSTRUMENTS: [InstrumentDef; DrumVoice::COUNT] = [
    ...
    InstrumentDef {
        ...
        special_params: &[
            ...
            SpecialParamDef {
                name: "snare_saturation_output_gain",
                label: "Saturation Output Gain",
                default: 1.0,
                min: 0.5,
                max: 2.0,
            ...
            SpecialParamDef {
                name: "snare_saturation_pre_filter",
                label: "Saturation Pre-Filter",
                default: 0.0,
                min: 0.0,
                max: 1.0,
    ...
    InstrumentDef {
        ...
        special_params: &[
            ...
            SpecialParamDef {
                name: "tom_saturation_output_gain",
                label: "Saturation Output Gain",
                default: 1.0,
                min: 0.5,
                max: 2.0,
            ...
            SpecialParamDef {
                name: "tom_saturation_pre_filter",
                label: "Saturation Pre-Filter",
                default: 0.0,
                min: 0.0,
                max: 1.0,
    ...
    InstrumentDef {
        ...
        special_params: &[
            ...
            SpecialParamDef {
                name: "bassdrum808_saturation_type",
                label: "Saturation Type",
                default: 0.0,
                min: 0.0,
                max: 5.0,
            ...
            SpecialParamDef {
                name: "bassdrum808_saturation_amount",
                label: "Saturation Amount",
                default: 0.0,
                min: 0.0,
                max: 1.0,
            ...
            SpecialParamDef {
                name: "bassdrum808_saturation_mix",
                label: "Saturation Mix",
                default: 1.0,
                min: 0.0,
                max: 1.0,
            ...
            SpecialParamDef {
                name: "bassdrum808_saturation_output_gain",
                label: "Saturation Output Gain",
                default: 1.0,
                min: 0.5,
                max: 2.0,
    ...
    InstrumentDef {
        ...
        special_params: &[
            ...
            SpecialParamDef {
                name: "perc1_saturation_output_gain",
                label: "Saturation Output Gain",
                default: 1.0,
                min: 0.5,
                max: 2.0,
            ...
            SpecialParamDef {
                name: "perc1_saturation_pre_filter",
                label: "Saturation Pre-Filter",
                default: 0.0,
                min: 0.0,
                max: 1.0,

...
pub const INSTRUMENTS: [InstrumentDef; DrumVoice::COUNT] = [
    ...
    InstrumentDef {
        ...
        algo_count: 2,
        special_params: &[
            SpecialParamDef { name: "perc1_sweep", label: "Sweep", default: 0.5, min: -1.0, max: 1.0, special_index: 0 },
            SpecialParamDef { name: "perc1_speed", label: "Speed", default: 80.0, min: 5.0, max: 300.0, special_index: 1 },
            SpecialParamDef { name: "perc1_bite", label: "Bite", default: 0.0, min: 0.0, max: 1.0, special_index: 2 },
            SpecialParamDef { name: "perc1_width", label: "Width", default: 0.0, min: 0.0, max: 1.0, special_index: 3 },
        ],
